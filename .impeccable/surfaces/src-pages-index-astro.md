...
related_targets: ["src/pages/de/[origem].astro","src/layouts/Landing.astro"]
---

# Landing (carpelabs.io `/` e `/de/<origem>`)

Modo: Persuade. Público e prova: ver PRODUCT.md. Ação: "Iniciar um projeto" (formulário na própria página).
